...
This [`install.sh`](https://raw.githubusercontent.com/rust-marker/marker/v0.4.1/scripts/release/install.sh) script, can be used to automatically download and verify Marker's binaries.
